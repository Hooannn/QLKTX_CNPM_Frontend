...
export default function UpdateBookingTimeModal(props: {
    ...
    const createUserMutation = useMutation({
        mutationFn: (params: {
            ...
            axios.put<IResponseData<BookingTime>>(`/api/v1/booking/booking-time/${props.bookingTime.id}`, params),
        onError,
        onSuccess(data) {
                            ...
                            <ModalBody>
                                <div className="w-full h-full flex flex-col gap-4">
                                    ...
                                    <Input
                                        ...
                                        defaultValue={dayjs(props.bookingTime.start_date).format("MM/DD/YYYY").toString()}
                                    ...
                                    <Input
                                        ...
                                        defaultValue={dayjs(props.bookingTime.end_date).format("MM/DD/YYYY").toString()}
                                        placeholder="mm/dd/yyyy"
                                        variant="bordered"
                                        size={"md"}
                                    ...
                                    <Select
                                        ...
                                        defaultSelectedKeys={[props.bookingTime.open ? "yes" : "no"]}
                                        {...register('open', {
